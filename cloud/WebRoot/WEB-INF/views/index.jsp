...
<div class="wrap">
    ...
    <div class="main">
        <div class="main-left">
            <div class="sfq">
				  <dl  >
					<dt class="change"><span class="bg1"><img src="${ctx}/style/img/12.png" width="30px"> </span><a href="javascript:;">数据应用中心</a></dt>
					<dd>
						<ol>
							<li onclick="createTab('/rights/toBillInfo','交易流水','jyls')"><i><img src="${ctx}/style/img/13.png"></i><a href="javascript:;">交易流水</a></li>
						</ol>
						<ol>
							<li onclick="createTab('/serviceInfo/toServiceInfo','终端管理','zdgl')"><i><img src="${ctx}/style/img/13.png"></i><a href="javascript:;">终端管理</a></li>
						</ol>
						<ol>
							<li onclick="createTab('/serviceInfo/toHeartBeat','超时时间管理','xtgl')"><i><img src="${ctx}/style/img/13.png"></i><a href="javascript:;">超时时间管理</a></li>
						</ol>
                        <ol>
                            <li onclick="createTab('/serviceInfo/initBenefitUrlPage','权益平台url设置','qypturlsz')"><i><img src="${ctx}/style/img/13.png"></i><a href="javascript:;">权益平台url设置</a></li>
                        </ol>
					</dd>
				</dl>
            </div>

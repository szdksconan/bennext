    ...
    <script type="text/javascript">
        ...
        function addhb(){
            ...
            parent.$.messager.confirm('提示', '提交数据？', function(b) {
                if (b) {
                    $.post('${ctx}/serviceInfo/heartBeatEdit', {
                        "time" : hb
                    }, function(result) {
                        if (result.success) {
                    ...
                    <form id="addForm" method="post" action="${ctx}/rights/exportBill">
                        <table>
                            <tr>
                                <th>超时时间(秒):</th>
                                <td>
                                    <input name="time" id="time" value="${heartbeat}" placeholder=""/></td>
                                <td>
                                    <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon_input',plain:true" onclick="addhb();">保存</a>
                                </td>
                            </tr>
                        </table>
                    </form>

	...
	<script type="text/javascript">
		...
		function editFun(id) {
			...
			parent.$.modalDialog({
				...
				width : 650,
				height : 200,
				href : '${ctx}/park/toExitWayEdit?id=' + id,
				buttons : [ {
					text : '保存',
					handler : function() {
						parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
						var f = parent.$.modalDialog.handler.find('#exitWayEditForm');
						f.submit();
					}
				},{
					text : '关闭',
...
<div data-options="region:'center',border:false,title:'出口'" >
